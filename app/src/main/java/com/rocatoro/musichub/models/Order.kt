...
class Order(
    ...
    @SerializedName("id_delivery") val id_delivery: String? = null,
    ...
    override fun toString(): String {
        return "Order(id=$id, id_client='$id_client', id_delivery=$id_delivery, id_address='$id_address', status=$status, timestamp=$timestamp, products=$products, client=$client, address=$address)"
    }
