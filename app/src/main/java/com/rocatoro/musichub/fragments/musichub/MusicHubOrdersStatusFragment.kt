...
import com.rocatoro.musichub.activities.adapters.OrdersMusicHubAdapter
...
class MusicHubOrdersStatusFragment : Fragment() {

    val TAG = "MusicHubOrderStatus"
    ...
    var adapter: OrdersMusicHubAdapter? = null
    ...
    override fun onCreateView(
        ...
        myView = inflater.inflate(R.layout.fragment_music_hub_orders_status, container, false)
        ...
        ordersProvider?.getOrdersByStatus(status)?.enqueue(object: Callback<ArrayList<Order>>{
            override fun onResponse(call: Call<ArrayList<Order>>, response: Response<ArrayList<Order>>
                ...
                if (response.body() != null){
                    ...
                    adapter = OrdersMusicHubAdapter(requireActivity(),orders!!)
