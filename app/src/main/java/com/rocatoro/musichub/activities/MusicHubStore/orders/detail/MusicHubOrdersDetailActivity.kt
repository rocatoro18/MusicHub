package com.rocatoro.musichub.activities.MusicHubStore.orders.detail
...
class MusicHubOrdersDetailActivity: AppCompatActivity() {

    val TAG = "MusicHubOrdersDetail"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_music_hub_orders_detail)

        order = gson.fromJson(intent.getStringExtra("order"),Order::class.java)

        toolbar = findViewById(R.id.toolbar)
        toolbar?.title = "Orden # ${order?.id} ADMIN VIEW"
